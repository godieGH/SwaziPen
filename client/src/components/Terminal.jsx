...
function TopAddressBar() {
   return (
      <div className="flex items-center gap-3 bg-transparent">
         <div className="flex items-center gap-2 bg-[#6b4f2e] rounded-full px-3 py-1">
            <span className="text-white text-sm font-medium">
               localhost:5173
            </span>
         </div>
         <div className="ml-auto flex items-center gap-2">
            <div className="w-6 h-6 bg-[#2c2c2c] rounded-full flex items-center justify-center">
...
function TopTabs({ active = 0, tabs = ["Console"] }) {
   return (
      <div className="flex items-center gap-4 px-3 pt-2 pb-1 border-b border-slate-700">
         {tabs.map((t, i) => (
            <div
               key={t}
   ...
   return (
      <div className="flex items-center justify-between px-3 py-2 border-b border-slate-800">
         <div className="flex items-center gap-2">
            <button className="text-xs px-2 py-1 rounded bg-slate-700 text-white">
               All
            </button>
...
function BottomInput() {
   return (
      <div className="border-t border-slate-800 px-3 py-3 flex items-center">
         ...
         <div className="flex-1 ml-2 text-slate-500"></div>
      </div>
   );
}
